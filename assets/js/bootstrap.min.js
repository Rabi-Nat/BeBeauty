...
!(function (t, e) {
                  ...
                  if (("next" === t ? ((n = "carousel-item-start"), (i = "carousel-item-next"), (o = "left")) : ((n = "carousel-item-end"), (i = "carousel-item-prev"), (o = "right")), l && l.classList.contains("active")))
                      ...
                      if (((this._isSliding = !0), f && this.pause(), this._setActiveIndicatorElement(l), (this._activeElement = l), this._element.classList.contains("slide"))) {
                          ...
                          B.one(s, "transitionend", function () {
                              ...
                              h(s, d);
                      } else s.classList.remove("active"), l.classList.add("active"), (this._isSliding = !1), B.trigger(this._element, "slid.bs.carousel", { relatedTarget: l, direction: o, from: a, to: c });
                      f && this.cycle();
                  }
              }),
  ...
  function Et(t) {
      ...
      return n && "body" === ct(n) && "static" === vt(n).position
          ? e
          : n ||
                (function (t) {
  ...
  var At = {
          ...
          effect: function (t) {
              ...
              null != r &&
                  ...
                  mt(e.elements.popper, r) &&
                  ((e.elements.arrow = r), (e.modifiersData[i + "#persistent"] = { padding: Ot("number" != typeof a ? a : Lt(a, rt)) }));
          },
  ...
  function Dt(t) {
      ...
      var _,
          b = Object.assign({ position: s }, l && Ct);
      return a
          ? Object.assign(
                Object.assign({}, b),
                {},
  ...
  var xt = {
          ...
          fn: function (t) {
              ...
              null != e.modifiersData.popperOffsets &&
                  (e.styles.popper = Object.assign(Object.assign({}, e.styles.popper), Dt(Object.assign(Object.assign({}, a), {}, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s })))),
                  null != e.modifiersData.arrow && (e.styles.arrow = Object.assign(Object.assign({}, e.styles.arrow), Dt(Object.assign(Object.assign({}, a), {}, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1 })))),
          ...
          ? Qt(
                (function (t) {
                    var e = ut(t),
                        ...
                        s = 0,
                        a = 0;
                    return i && ((o = i.width), (r = i.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((s = i.offsetLeft), (a = i.offsetTop))), { width: o, height: r, x: s + Rt(t), y: a };
                })(t)
            )
          : dt(e)
          ? (function (t) {
                          ...
                          return t.concat(
                              "auto" === pt(n)
                                  ? (function (t, e) {
                                    ...
                                    })(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g })
                                  : n
                          );
                      }, []),
                      y = e.rects.reference,
  ...
  var $t = {
          ...
          fn: function (t) {
              var e = t.state,
                  ...
                  s = qt(e, { elementContext: "reference" }),
      ...
      Jt = {
          ...
          fn: function (t) {
              var e = t.state,
                  ...
                  p = n.tetherOffset,
                  g = void 0 === p ? 0 : p,
                  m = qt(e, { boundary: l, rootBoundary: c, padding: f, altBoundary: u }),
                  v = pt(e.placement),
                  _ = Ft(e.placement),
                  b = !_,
                  y = Tt(v),
  ...
  function te(t, e, n) {
      ...
      return (
          (a || (!a && !n)) &&
              (("body" !== ct(e) || Wt(r)) && (l = (i = e) !== ut(i) && dt(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Ht(i)), dt(e) ? (((c = Bt(e)).x += e.clientLeft), (c.y += e.clientTop)) : r && (c.x = Rt(r))),
          ...
          var o,
              ...
              u = {
                  ...
                  setOptions: function (n) {
                      f(), (a.options = Object.assign(Object.assign(Object.assign({}, r), a.options), n)), (a.scrollParents = { reference: ft(t) ? Kt(t) : t.contextElement ? Kt(t.contextElement) : [], popper: Kt(e) });
                      var o,
                          s,
                          c = (function (t) {
                              var e = (function (t) {
                  ...
                  forceUpdate: function () {
                      if (!c) {
                          var t = a.elements,
                              ...
                              n = t.popper;
                          if (ne(e, n)) {
                              (a.rects = { reference: te(e, Et(n), "fixed" === a.options.strategy), popper: gt(n) }),
                                  (a.reset = !1),
  ...
  var oe = ie(),
      re = ie({ defaultModifiers: [jt, Zt, xt, ht] }),
      se = ie({ defaultModifiers: [jt, Zt, xt, ht, Gt, zt, Jt, At, $t] }),
      ae = Object.freeze({
          __proto__: null,
          popperGenerator: ie,
          detectOverflow: qt,
      ...
      me = { offset: 0, flip: !0, boundary: "clippingParents", reference: "toggle", display: "dynamic", popperConfig: null },
                      ...
                      for (var e = Y.find('[data-bs-toggle="dropdown"]'), n = 0, i = e.length; n < i; n++) {
                          ...
                          if ((t && "click" === t.type && (a.clickEvent = t), s)) {
                              ...
                              if (
                                  ...
                                  !((t && (("click" === t.type && /input|textarea/i.test(t.target.tagName)) || ("keyup" === t.type && "Tab" === t.key)) && c.contains(t.target)) || B.trigger(r, "hide.bs.dropdown", a).defaultPrevented)
                              )
                                  "ontouchstart" in document.documentElement &&
  ...
  var be = { backdrop: !0, keyboard: !0, focus: !0 },
      ye = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean" },
      we = (function (t) {
          function o(e, n) {
              var i;
              return (
              ...
              (r.setElementContent = function (t, e) {
                  if (null !== t)
                      return "object" == typeof e && d(e)
                          ...
                          : void (this.config.html ? (this.config.sanitize && (e = Oe(e, this.config.allowList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
              }),
              (r.getTitle = function () {
  ...
  var Ie = "popover",
      ...
      Me = n({}, Ne.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
      Be = n({}, Ne.DefaultType, { content: "(string|element|function)" }),
      He = {
          ...
          return (
              ...
              (r._activate = function (t) {
                  ...
                  n.classList.contains("dropdown-item")
                      ? (Y.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active"))
